...
public class A_back_QuestionAdapter extends FirebaseRecyclerAdapter<A_QuestionModel, A_back_QuestionAdapter.myViewHolder> {
     ...
     * @param options
     */
    public A_back_QuestionAdapter(@NonNull FirebaseRecyclerOptions<A_QuestionModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull A_QuestionModel model) {
