...
public class A_back_AddBioActivity extends AppCompatActivity {
    ...
    private void insertData()
    {
        ...
        FirebaseDatabase.getInstance().getReference().child("Biology").push()
                .setValue(map)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Toast.makeText(A_back_AddBioActivity.this,"Data Added Successfully",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(Exception e) {
                        ...
                        Toast.makeText(A_back_AddBioActivity.this,"Error While Insertion",Toast.LENGTH_SHORT).show();
                    }
                });
