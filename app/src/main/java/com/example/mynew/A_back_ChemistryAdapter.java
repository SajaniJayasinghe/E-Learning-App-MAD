...
public class A_back_ChemistryAdapter extends FirebaseRecyclerAdapter<A_ChemistryModel, A_back_ChemistryAdapter.myViewHolder> {
     ...
     * @param options
     */
    public A_back_ChemistryAdapter(@NonNull FirebaseRecyclerOptions<A_ChemistryModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull A_back_ChemistryAdapter.myViewHolder holder, final int position, @NonNull A_ChemistryModel model) {
            ...
            public void onClick(View v) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Chem")
    ...
    @NonNull
    @Override
    public A_back_ChemistryAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.a_back_main_item,parent,false);

        return new A_back_ChemistryAdapter.myViewHolder(view);
    }
