...
public class A_back_MathsAdapter extends FirebaseRecyclerAdapter<A_MathsModel, A_back_MathsAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public A_back_MathsAdapter(@NonNull FirebaseRecyclerOptions<A_MathsModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull A_back_MathsAdapter.myViewHolder holder, final int position, @NonNull A_MathsModel model) {
            ...
            public void onClick(View v) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Maths")
    ...
    @NonNull
    @Override
    public A_back_MathsAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.a_back_main_item,parent,false);

        return new A_back_MathsAdapter.myViewHolder(view);
    }
